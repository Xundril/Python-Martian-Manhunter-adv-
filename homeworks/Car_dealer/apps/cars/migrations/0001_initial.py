...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('category', models.CharField(choices=[('small', 'Small'), ('midsize', 'Midsize'), ('large', 'Large'), ('luxury', 'Luxury'), ('sports', 'Sports')], default='midsize', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pollutant_type', models.CharField(choices=[('a+', 'A+'), ('a', 'A'), ('b', 'B'), ('c', 'C'), ('d', 'D'), ('e', 'E'), ('f', 'F'), ('g', 'G')], default='a', max_length=10)),
